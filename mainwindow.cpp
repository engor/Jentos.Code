...
void MainWindow::onFindUsages() {
    ...
    tree->expandAll();
    _ui->consoleTabWidget->setCurrentWidget(_ui->tabUsages);
...
void MainWindow::onSourceMenu( const QPoint &pos ) {
    ...
    qDebug()<<"onSourceMenu"<<index.column()<<index.row();
...
void MainWindow::print(const QString &str, QString kind ){
    if(kind == "") {
        ...
        _ui->consoleTabWidget->setCurrentWidget(_ui->tabOutput);
    }
    else if(kind == "finish") {
